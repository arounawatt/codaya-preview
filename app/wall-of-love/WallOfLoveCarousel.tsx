...
export default function WallOfLoveCarousel({ slug, companyName, category, score, totalReviews, reviews, companyPhone, googleMapUrl, companyWebsite  }: WallOfLoveCarouselProps) {
        ...
        <div style={{
          ...
          <div style={{ position: 'relative', zIndex: 1 }}>
            ...
            <div style={{ marginTop: '24px' }}>
                <a
                  href={companyWebsite || `https://${slug}.codaya.fr`}
                  target="_blank"
                  rel="noopener noreferrer"
                  style={{
                    display: 'inline-flex',
                ...
                >
                  ...
                  <span>Visitez notre site pour decouvrir toutes nos prestations</span>
